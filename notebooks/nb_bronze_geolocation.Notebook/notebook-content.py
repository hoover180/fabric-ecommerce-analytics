...
# Bronze ingestion for [geolocation] — full replace, partitioned by state for downstream filter performance.
...
spark.sql("""
    SELECT table_name, rows_loaded, status, run_timestamp 
