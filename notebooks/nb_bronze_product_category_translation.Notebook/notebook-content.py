...
# Bronze ingestion for [product_category_translation] — full replace load.

from datetime import date

TABLE_NAME       = "product_category_translation"
SOURCE_FILE      = "Files/Bronze/raw/olist_product_category_name_translation.csv"
DELTA_PATH       = "Tables/Bronze/product_category_translation"
EXPECTED_COLUMNS = [
