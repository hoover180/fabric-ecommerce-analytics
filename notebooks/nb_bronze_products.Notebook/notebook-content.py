...
# Bronze ingestion for [products] — full replace load.

from datetime import date

TABLE_NAME       = "products"
SOURCE_FILE      = "Files/Bronze/raw/olist_products_dataset.csv"
DELTA_PATH       = "Tables/Bronze/products"
EXPECTED_COLUMNS = [
...
# Note: product_name_lenght and product_description_lenght are typos in the
# source dataset's own column headers (not a mistake here) — preserved
# as-is at Bronze since Bronze mirrors the source exactly; corrected to
# proper spelling at Silver, where conforming/renaming belongs.
