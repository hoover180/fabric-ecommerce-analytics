...
--       Silver baseline is scoped via EXISTS to only orders that
--       have matching order_items rows — orders with payments but
--       no items are legitimately excluded from fact_orders since
