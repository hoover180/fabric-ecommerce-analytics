...
--             ~994 invalid scores nulled at Silver.
--             Confirmed: 0 valid reviews have a null score in fact_orders.
...
SELECT
    'review_score_null_count (5556 tolerated — see note)' AS check_name,
    COUNT(*) AS count,
    CASE WHEN COUNT(*) <= 6000 THEN 'PASS' ELSE 'FAIL' END AS result
FROM dbo.fact_orders
